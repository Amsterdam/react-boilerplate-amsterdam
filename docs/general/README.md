...
to the `body` when the fonts have loaded. (see [`app.js`](../../src/app.js#L26-L36)
and [`App/styles.css`](../../src/containers/App/styles.css))

### Adding a new font

1.  Either add the `@font-face` declaration to `App/styles.css` or add a `<link>`
    tag to the [`index.html`](../../src/index.html). (Don't forget to remove the `<link>`
    for Open Sans from the [`index.html`](../../src/index.html)!)
